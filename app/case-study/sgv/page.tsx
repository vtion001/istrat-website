    ...
    <main id="main" className="w-full overflow-x-hidden bg-black text-white">
      <section className="max-w-7xl mx-auto px-6 md:px-8 py-24">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <p className="text-[#DC7026] text-[10px] font-bold mb-4 uppercase tracking-[0.3em]">Case Study • Corporate Event</p>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05] mb-6 brand-gradient-text bg-clip-text text-transparent" style={{ fontFamily: 'var(--font-display)' }}>SGV Got Talent</h1>
          <p className="text-gray-400 text-lg md:text-xl leading-relaxed max-w-3xl mb-12">A high-energy talent showcase for a leading professional services firm, produced with premium staging, live content, and audience engagement.</p>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <p className="text-gray-300">Deliver a polished corporate showcase with seamless flow, AV integration, and interactive audience experience, aligned with brand standards.</p>
          </div>
          <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300">Boosted internal morale and brand equity with exceptional satisfaction and measurable engagement uplift.</p>
          </div>
