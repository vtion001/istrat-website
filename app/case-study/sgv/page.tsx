          ...
          <div className="grid grid-cols-2 gap-4">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="relative w-full aspect-square border border-white/10 bg-white/5">
                <Image src="https://www.istratmc.com/wp-content/uploads/2022/05/Brand-Development-and-Strategy.png" alt="Production still" fill className="object-cover opacity-90" />
