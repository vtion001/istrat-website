    ...
    <main id="main" className="w-full overflow-x-hidden bg-[#0d1a2b]">
      <section className="max-w-7xl mx-auto px-6 md:px-8 py-24">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <p className="text-xs md:text-sm uppercase tracking-[0.25em] text-[#c59f43] mb-4">Case Study • Corporate Event</p>
          ...
          <p className="text-lg md:text-xl text-[#c59f43] leading-relaxed max-w-3xl mb-12">A high-energy talent showcase for a leading professional services firm, produced with premium staging, live content, and audience engagement.</p>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <p className="text-[#c59f43]">Deliver a polished corporate showcase with seamless flow, AV integration, and interactive audience experience, aligned with brand standards.</p>
          </div>
          <div className="space-y-6">
            <h2 className="text-2xl font-display text-[#c59f43]">Approach</h2>
            <p className="text-[#c59f43]">Comprehensive production: stage and set design, lighting, sound, motion graphics, and live content operations with precise stage management.</p>
          </div>
          <div className="space-y-6">
            <h2 className="text-2xl font-display text-[#c59f43]">Impact</h2>
            <p className="text-[#c59f43]">Boosted internal morale and brand equity with exceptional satisfaction and measurable engagement uplift.</p>
          </div>
