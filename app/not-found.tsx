    ...
    <main className="w-full overflow-x-hidden bg-[#0d1a2b]">
      <section className="max-w-7xl mx-auto px-6 md:px-8 py-32">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <p className="text-lg md:text-xl text-[#c59f43] leading-relaxed max-w-2xl mb-8">The page you’re looking for does not exist. Explore our latest highlights and case studies.</p>
