    ...
    return (
        <div className="flex flex-col gap-4">
            <div className="p-4 border border-white/5 bg-[#080808] rounded-[24px]">
                <p className="text-[#DC7026] text-base md:text-lg font-bold uppercase mb-6 sm:mb-8" style={{ fontFamily: 'var(--font-ibm-plex)', fontWeight: 700 }}>Office Headquarters</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="p-4 border border-white/5 bg-[#080808] rounded-[16px]">
                    <p className="text-[#DC7026] text-base md:text-lg font-bold uppercase mb-6 sm:mb-8" style={{ fontFamily: 'var(--font-ibm-plex)', fontWeight: 700 }}>Phone</p>
                ...
                <div className="p-4 border border-white/5 bg-[#080808] rounded-[16px]">
                    <p className="text-[#DC7026] text-base md:text-lg font-bold uppercase mb-6 sm:mb-8" style={{ fontFamily: 'var(--font-ibm-plex)', fontWeight: 700 }}>Email</p>
