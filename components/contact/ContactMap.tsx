...
export default function ContactMap() {
    return (
        <section id="section3" className="max-w-7xl mx-auto px-6 md:px-8 py-4">
            <div className="w-full h-72 border border-white/5 rounded-[32px] grayscale hover:grayscale-0 transition-all duration-500 overflow-hidden">
                <iframe
