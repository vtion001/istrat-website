                                ...
                                <div className="max-w-7xl w-full h-[90dvh] md:h-[80vh] relative">
                                    ...
                                    <div className="h-full pt-8 sm:pt-6 md:pt-8 pb-12 sm:pb-12 md:pb-16 lg:pb-20 xl:pb-24 px-6 sm:px-12 md:px-16 lg:px-20 xl:px-24 flex flex-col items-center relative text-center">
                                        ...
                                        <div className="relative w-full h-full flex flex-col items-center">
                                            ...
                                            {value.svgUrl ? (
                                                <div className="absolute top-[35%] md:top-[42%] lg:top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[126%] h-[22.5vh] sm:w-[135%] sm:h-[45vh] md:w-[180%] md:h-[1260px] lg:h-[1440px] pointer-events-none z-0">
                                                    <Image
                                                        src={value.svgUrl}
                                                        alt={value.title}
                                                        fill
