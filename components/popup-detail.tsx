    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          />
          <motion.div
            className="absolute inset-x-4 md:inset-x-24 top-20 md:top-24 border border-gray-200 bg-white shadow-2xl"
            ...
            <div className="relative p-6 md:p-8 max-h-[70vh] overflow-y-auto">
              ...
              <div className="relative">
                ...
                {images.length > 0 && (
                  <div className="flex justify-center mb-6">
                    <motion.div
                      ...
                      className="relative w-full md:w-3/4 border border-gray-200 bg-gray-50"
                    >
                      <img
                        src={images[0]}
                ...
                <div className="flex items-center justify-between gap-3">
                  <button onClick={onClose} className="px-4 py-3 border border-gray-300 text-gray-700 hover:bg-gray-100 transition-colors">Close</button>
                  <a href={ctaHref} className="inline-flex items-center gap-3 px-6 py-4 bg-[#DC7026] text-white hover:bg-[#E8A351] transition-colors">
                    {ctaLabel}
