        ...
        <section id="section1" className="relative min-h-[60vh] sm:h-[70vh] md:h-[75vh] lg:h-[80vh] flex items-center overflow-hidden bg-black pt-32 sm:pt-8">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 w-full py-16 sm:py-0 mt-12">
                <div className="text-center max-w-5xl mx-auto">
                    ...
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold uppercase tracking-wide mb-6 sm:mb-8" style={{ fontFamily: 'var(--font-display)' }}>
                        HOW WE HELP YOU WIN
                    </h3>

                    {/* 2. Middle Section - Orange Heading */}
                    <h2 className="text-[#DC7026] text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black uppercase tracking-tight leading-[1.1] mb-8 sm:mb-12" style={{ fontFamily: 'var(--font-display)' }}>
                    ...
                    <h2 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black uppercase tracking-tight leading-[1.05]" style={{ fontFamily: 'var(--font-display)' }}>
